...
function App() {
  const [messages, setMessages] = useState([
    { role: 'bot', text: 'Привет! Я Толик, помогу вам забронировать столик. 🥃 Могу рассказать, какие диджеи, специальные предложения и мероприятия у нас планируются. Чего изволите: бронируем или просвещаемся?' }
  ]);
