...
const RECIPES = {
  ...
  "Каси": { base: 1150, assembly: { "Джин Kinross": 300, "П/ф Спотыкач": 350, "П/ф яблочный кордиал": 350, "Вода": 150 } },
  "Личи Колада": { base: 1020, assembly: { "Ром Ангостура 3 года": 450, "Balance ананас/личи": 350, "Пюре замороженное ананас": 100, "П/ф яблочный кордиал": 120 } },
  "Mint Bramble": { base: 90, assembly: { "Джин Kinross": 45, "Balance Ежевика/мята": 40, "П/ф яблочный кордиал": 5 } },
  "Сникерс": { base: 900, assembly: { "П/ф Настойка арахис": 450, "П/ф Сироп Шоколад": 440, "П/ф Соленой раствор": 10, "Ваниль (по вкусу)": 0, "Карамель аромка (по вкусу)": 0 }, prep: { "П/ф Настойка арахис": { "Водка": 450, "Арахис": 225 }, "П/ф Сироп Шоколад": { "Сахар": 250, "Какао порошок (г)": 50, "Вода фильтрованная": 440 }, "П/ф Соленой раствор": { "Вода": 10, "Соль": 1 } } },
"Мэри Микс (сангрита)": { base: 970, assembly: { "Томатный сок": 800, "Сок лайма (СуперДжус)": 60, "Сокус табаско": 16, "Соус ворчестер": 8, "Соль (б.л.)": 2, "Паприка (б.л.)": 3, "Перец черный молотый (б.л.)": 1, "П/ф Сахарный сироп": 80 } },
};
