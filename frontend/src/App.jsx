...
// === БАЗА ЗНАНИЙ ТЕХКАРТ ===
const RECIPES = {
  "Щавлик": { base: 1000, assembly: { "Водка Schmidt": 250, "П/ф сироп щавель": 270, "П/ф раствор яблочной кислоты": 280, "Ароматизатор манго (по вкусу)": 0 }, prep: { "П/ф сироп щавель": { "Сахарный сироп": 1000, "Щавель свежий (г)": 140 } } },
