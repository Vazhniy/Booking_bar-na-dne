...
const RECIPES = {
  ...
  "Спотыкач": { base: 1000, assembly: { "П/ф Настойка черная смородина": 720, "П/ф Сахарный сироп": 280 }, prep: { "П/ф Настойка черная смородина": { _base: 720, "Водка Schmidt": 654.6, "Черная смородина с/м (г)": 523.7, "Можжевеловая ягода (г)": 4.5 } } },
