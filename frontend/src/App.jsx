...
// === БАЗА ЗНАНИЙ ТЕХКАРТ ===
const RECIPES = {
  "Щавлик": { base: 1000, assembly: { "Водка Schmidt": 250, "П/ф сироп щавель": 270, "П/ф раствор яблочной кислоты": 250, "Ароматизатор манго (по вкусу)": 0 }, prep: { "П/ф сироп щавель": { "Сахарный сироп": 1000, "Щавель свежий (г)": 140 } } },
  ...
  "Барби": { base: 1015, assembly: { "Водка Schmidt": 300, "Концентрат Richeza черника-мята": 70, "П/ф сироп Черника": 100, "Сироп Richeza дыня": 140, "Сливки 10%": 175, "Молоко": 175, "Вода": 50, "Молочная кислота (По вкусу дэш)": 0 } },
  "Крестный молочник": { base: 720, assembly: { "Виски": 200, "Молоко": 200, "Сливки 10%": 200, "П/ф Медовый сироп": 100, "Сироп попкорн": 20 } },
  "Кэри": { base: 1100, assembly: { "П/ф настойка клубника": 450, "Концентрат Грейпфрут/Малина": 120, "П/ф раствор яблочной кислоты": 250, "П/ф сахарный сироп": 280 }, prep: { "П/ф настойка клубника": { "Водка Schmidt": 1000, "Клубника св м (г)": 700 } } },
  "Минталлика": { base: 1000, assembly: { "Водка Schmidt": 452, "Balance Киви/мята": 452, "Сахарный сироп": 40, "Суперджус лайм": 40, "Сироп мята Giffard": 15 } },
  "Цитрон": { base: 1000, assembly: { "П/ф Настойка Саган дайля": 480, "Super juice lime": 280, "П/ф сахарный сироп": 240 }, prep: { "П/ф Настойка Саган дайля": { "Водка Schmidt": 1000, "Саган Дайля (г)": 5 } } },
  "Мандарини": { base: 1000, assembly: { "П/ф Настойка Гибискус": 480, "Пюре каламанси": 150, "Сахарный сироп": 300, "П/ф раствор яблочной кислоты": 70 }, prep: { "П/ф Настойка Гибискус": { "Водка Schmidt": 1000, "Чай каркадэ (г)": 14 } } },
  "Черрибос": { base: 1000, assembly: { "П/ф Настойка Вишня/ройбуш": 480, "Ароматизатор персик": 0, "П/ф кордиал яблочной кислоты": 490, "П/ф раствор яблочной кислоты": 30 }, prep: { "П/ф Настойка Вишня/ройбуш": { "Водка Schmidt": 1000, "Вишня с/м (г)": 600, "Ройбуш (г)": 8 } } },
  "Тайская": { base: 1000, assembly: { "П/ф Настойка Чили": 450, "Balance Маракуйя/ваниль": 380, "П/ф яблочный кордиал": 170 }, prep: { "П/ф Настойка Чили": { "Водка Schmidt": 1000, "Чили свежий (г)": 12 } } },
  "Зубровка": { base: 1000, assembly: { "П/ф Настойка Зубровка": 600, "П/ф Настойка на корках": 200, "П/ф сахарный сироп": 200 }, prep: { "П/ф Настойка Зубровка": { "Водка Schmidt": 1000, "Зубровка (г)": 3, "Душица (г)": 1, "Мята сух. (г)": 1.5 } } },
