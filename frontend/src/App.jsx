...
const RECIPES = {
  ...
  "Каси": { base: 1150, assembly: { "Джин Kinross": 300, "П/ф Спотыкач": 350, "П/ф Кордиал яблочной кислоты": 350, "Вода": 150 } },
  ...
  "Сникерс": { base: 900, assembly: { "П/ф Настойка арахис": 450, "П/ф Сироп Шоколад": 440, "П/ф Соленой раствор": 10, "Ваниль (по вкусу)": 0, "Карамель аромка (по вкусу)": 0 }, prep: { "П/ф Настойка арахис": { "Водка Schmidt": 450, "Арахис (г)": 225 }, "П/ф Сироп Шоколад": { "Сахар (г)": 250, "Какао порошок (г)": 50, "Вода": 440 }, "П/ф Соленой раствор": { "Вода": 10, "Соль (г)": 1 } } },
  "Мэри Микс (сангрита)": { base: 970, assembly: { "Томатный сок": 800, "П/ф Super Juice (Лайм)": 60, "Соус табаско": 16, "Соус ворчестер": 8, "Соль (б.л.)": 2, "Паприка (б.л.)": 3, "Перец черный молотый (б.л.)": 1, "П/ф Сахарный сироп": 80 } }
