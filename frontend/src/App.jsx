...
// === БАЗА ЗНАНИЙ ТЕХКАРТ ===
const RECIPES = {
  "Щавлик": { base: 1000, assembly: { "Водка Schmidt": 325, "П/ф Сироп щавель": 350, "П/ф Раствор яблочной кислоты": 325, "Ароматизатор манго (по вкусу)": 0 }, prep: { "П/ф Сироп щавель": { "П/ф Сахарный сироп": 1000, "Щавель свежий (г)": 160 } } },
  ...
  "Тиргартен": { base: 113, assembly: { "П/ф Настойка Зубровка": 40, "П/ф Кордиал Клубника/Фейхоа": 40, "Абсент": 8 } },
  "Бергхаин": { base: 111, assembly: { "П/ф Настойка на корках": 40, "П/ф Кордиал Розмарин/каламанси": 40, "Ликер Бехеровка": 6 } },
  "Кройцбург": { base: 100, assembly: { "Егермейстер": 35, "Кампари": 15, "П/ф Кордиал Лаванда/грейпфрут": 50 } },
  "Бел порно": { base: 100, assembly: { "П/ф Крамбамбуля": 40, "Ликер Сюз": 10, "П/ф Кордиал Ваниль/маракуйя": 40, "П/ф Super Juice (Лимон)": 10 } },
  "Ampelmann": { base: 140, assembly: { "П/ф Виски/вишня": 60, "Сок клюква": 50, "Пюре малина": 30 }, prep: { "П/ф Виски/вишня": { "Виски Bells": 700, "Вишня с/м (г)": 500, "Сахар (г)": 200 } } },
  "КимЧи": { base: 1000, assembly: { "Водка": 385, "Balance лимон": 64, "Сахарный сироп": 50, "Томатный сок": 128, "Кимчи соус": 38, "Сладкий перец": 256, "Рассол": 77, "Паприка (г)": 2.5, "Душистый перец (шт)": 3, "Можжевеловая ягода (г)": 25 } }
};
