...
// === БАЗА ЗНАНИЙ ТЕХКАРТ ===
const RECIPES = {
  "Щавлик": { base: 1000, assembly: { "Водка Schmidt": 250, "П/ф Сироп щавель": 270, "П/ф Раствор яблочной кислоты": 250, "Ароматизатор манго (по вкусу)": 0 }, prep: { "П/ф Сироп щавель": { "П/ф Сахарный сироп": 1000, "Щавель свежий (г)": 160 } } },
