...
import rateLimit from 'express-rate-limit'; // Подключаем защиту от спама
...
- Если гость хочет забронировать стол, собери 6 данных: 1. Имя 2. Дата 3. Время 4. Кол-во гостей 5. Повод 6. Телефон.
- ПРАВИЛО ВРЕМЕНИ: Бронь столов принимается СТРОГО до 23:00. Если просят позже — саркастично отказывай.
